...
const projects: Project[] = [
  ...
  {
    img: image2,
    title: "Nike Air Max — Hackathon E-commerce",
    desc: "Pixel-clean Nike-style product showcase with hero, product detail and shop flow, built during the GIAIC hackathon.",
  ...
  {
    img: image6,
    title: "Task Manager — Hackathon Phase 2",
    desc: "Sign-in flow and task management UI with a polished gradient brand built for GIAIC Hackathon Phase 2.",
